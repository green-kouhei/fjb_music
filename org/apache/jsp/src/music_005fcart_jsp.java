...
public final class music_005fcart_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<td width=\"10%\"><select name=\"vol\">\r\n");
      out.write("\t\t\t\t\t\t<option value=\"サンプル1\">1</option>\r\n");
      out.write("\t\t\t\t\t\t<option value=\"サンプル2\">2</option>\r\n");
      out.write("\t\t\t\t\t\t<option value=\"サンプル3\">3</option>\r\n");
      out.write("\t\t\t\t</select></td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\t\t\t<tr width=\"100%\" style=\"table-layout: auto\">\r\n");
      out.write("\t\t\t\t<td width=\"30%\">注文合計</td>\r\n");
      out.write("\t\t\t\t<td width=\"40%\">なぞのスペース</td>\r\n");
      out.write("\t\t\t\t<td width=\"20%\">\\100/\\108</td>\r\n");
      out.write("\t\t\t\t<td width=\"10%\">1点</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr style=\"table-layout: auto\">\r\n");
      out.write("\t\t\t\t<td><input type=\"submit\" name=\"oder\" value=\"注文\"></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t</div>\r\n");
      out.write("\r\n");
